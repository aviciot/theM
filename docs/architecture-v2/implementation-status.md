...
| GET /ws/orchestrate/{app_slug}/{ep_slug} | ws | Bearer token |
| GET /sse/orchestrate/{app_slug}/{ep_slug} | sse | Bearer token |
| POST /sse/orchestrate/{app_slug}/{ep_slug} | sse | Bearer token |
