...
type SummaryStore interface {
	LoadSummary(ctx context.Context, contextID, tenantID, externalUserID string) (string, error)
	SaveSummary(ctx context.Context, contextID, runID, tenantID, externalUserID, summary string) error
}
...
func (o *Orchestrator) maybeSummarize(ctx context.Context, contextID, runID, tenantID, externalUserID string, history []domain.Message) []domain.Message {
	...
	prior, err := o.summaryStore.LoadSummary(ctx, contextID, tenantID, externalUserID)
	if err != nil {
	...
	if saveErr := o.summaryStore.SaveSummary(ctx, contextID, runID, tenantID, externalUserID, summary); saveErr != nil {
