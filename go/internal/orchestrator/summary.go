...
type SummaryStore interface {
	LoadSummary(ctx context.Context, contextID, tenantID, externalUserID string, userID int64) (string, error)
	SaveSummary(ctx context.Context, contextID, runID, tenantID, externalUserID string, userID int64, summary string) error
}
...
func (o *Orchestrator) maybeSummarize(ctx context.Context, contextID, runID, tenantID, externalUserID string, userID int64, history []domain.Message) []domain.Message {
	...
	prior, err := o.summaryStore.LoadSummary(ctx, contextID, tenantID, externalUserID, userID)
	if err != nil {
	...
	if saveErr := o.summaryStore.SaveSummary(ctx, contextID, runID, tenantID, externalUserID, userID, summary); saveErr != nil {
