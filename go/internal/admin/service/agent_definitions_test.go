...
func (f *agentDefFakeDal) SetOrchestratorSummarizer(_ context.Context, _, _ string, _ bool, _, _ int, _, _ *string) error { return nil }
...
func (f *agentDefFakeDal) GetRequiredParamsForAgent(_ context.Context, _ string) (dal.AgentParamsRow, error) {
