...
func (f *publishFakeDal) SetOrchestratorSummarizer(_ context.Context, _, _ string, _ bool, _, _ int, _, _ *string) error { return nil }
...
func (f *publishFakeDal) RevertPublishedToDraft(_ context.Context, _, _ string, _ []byte, _ string) error {
	return nil
}
...
func (f *publishFakeDal) GetAgentLLMNodes(_ context.Context, _, _ string) ([]byte, []byte, string, error) {
	return []byte("[]"), []byte("{}"), "", nil
}
func (f *publishFakeDal) UpsertNodeLLMOverride(_ context.Context, _, _, _, _, _ string) error {
	return nil
}
