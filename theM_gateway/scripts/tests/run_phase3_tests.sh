#!/usr/bin/env bash
# run_phase3_tests.sh — run all Phase 3 tests in order
# Usage: bash scripts/tests/run_phase3_tests.sh
# Set BRIDGE_URL, AUTH_SERVICE_URL, POSTGRES_CONTAINER, REDIS_CONTAINER as needed.
...
echo "========================================"
echo "  Odin Phase 3 Test Suite"
echo "========================================"

run_test "01 DB schema"           "bash '$SCRIPT_DIR/test_01_db.sh'"
run_test "02 Redis namespace"     "bash '$SCRIPT_DIR/test_02_redis.sh'"
