...
function ExecutionPolicySection({ policy, defaultPolicy, maxPolicy, setPolicyField }: ExecutionPolicySectionProps) {
  ...
  const ACCENT = '#7c3aed'; // violet — distinct from other sections
