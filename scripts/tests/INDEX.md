...
| 08 | `run_tests.py::test_08_tokens_api` | live | yes | Access tokens admin API — full CRUD + enable/disable |
| 09 | `run_tests.py::test_09_rate_limiter` | structural | no | `_slot()`, `check_rate_limit()` with no Redis, token hash logic, `_deps.py` structure |
...
| `app/adapters/` | 07 |
| `app/services/rate_limiter.py`, `token_cache.py` | 09 |
...
| `app/routers/admin_tokens.py` | 08 |
